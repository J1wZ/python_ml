...
@pytest.fixture
def collector():
    '''Возвращает обьект BooksCollector с одной добавленной книгой без жанра для тестирования'''
    coll = BooksCollector()
    coll.add_new_book(new_book_name)
    yield coll

def test_add_new_book_passed(collector):
    '''
...
def test_add_new_book_add_same_book(collector):
    '''
...
def test_add_new_book_invalid_name_type(collector, book_name):
    '''
        Тест проверяет метод add_new_book на проверку типа введенного имени книги \n
        Название книги может быть только строковым(str), словарь должен содержать только книгу добавленную в начале тестов collector
    '''
    collector.add_new_book(book_name)
    assert collector.get_books_genre() == {new_book_name: ''}


def test_set_book_genre_passed(collector):
    '''
...
def test_set_book_genre_invalid_genre_or_name(collector, book_name, book_genre):
    '''
...
def test_set_book_genre_invalid_genre_type(collector, book_genre):
    '''
...
def test_get_book_genre_passed(collector):
    '''
...
def test_get_book_genre_invalid_name_type(collector, invalid_book_name):
    '''
...
def test_get_books_with_specific_genre_passed(collector):
    '''
...
def test_get_books_with_specific_genre_invalid_genre_type(collector,book_genre):
    '''
...
def test_get_books_for_children_passed(collector, book_genre, expected_book_genre):
    '''
...
def test_add_book_in_favorites_passed(collector):
    '''
...
def test_add_book_in_favorites_add_same_book(collector):
    '''
...
def test_add_book_in_favorites_invalid_name_type(collector, invalid_book_name):
    '''
...
def test_delete_book_from_favorites_passed(collector):
    '''
...
def test_delete_book_from_favorites_invalid_name(collector):
    '''
...
def test_delete_book_from_favorites_invalid_name_type(collector, invalid_book_name):
    '''
